...
public class CustomSinnper extends LinearLayout {
	 ...
	 * 自定义listView 实现圆角功能
	 */
	protected CornerListView myListView;
	...
	public CustomSinnper(Context context, AttributeSet attrs) {
		...
		myListView = new CornerListView(mContext);
		myListView.setBackgroundResource(R.drawable.shape_bg_listview);
	...
	protected void initPopupWindow(Context context) {
		if (popup == null) {
			...
			popup.setContentView(myListView);
		}
		if (!popup.isShowing()) {
