...
import com.customspinner.CustomSinnper.OnItemSeletedListener;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// L.v("getDrawable>>" + triangView.getDrawable());
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int size = (int) (text.getText().length());
				Log.i("main click", size + "");
				text.setSelection(size);
